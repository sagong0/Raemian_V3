           ...
           <div class="memoutline" >
             ...
             <div class="memsel2">
                <ul>
                    ...
                    <li><input type="text" name="aid" class="admamber2"  value="" placeholder="아이디를 입력해 주세요"></li>
                    <li><button class="idcheck" id="ck_idBtn" value="">중복체크</button></li>
                </ul>    
              </div>
              <div class="memsel2">
                <ul>
                    <li class="memfont">패스워드</li>
                    <li><input type="password" class="admamber1" name="apw1" value="" placeholder="패스워드를 입력해 주세요"></li>
                    <li class="memfont">패스워드확인</li>
                    <li><input type="password" class="admamber4" name="apw2" value="" placeholder="동일한 패스워드를 입력해 주세요"></li>
                </ul>    
              </div>
              <div class="memsel3">
                <ul>
                    <li class="memfont">이메일</li>
                    <li><input type="text" class="admamber3" name="aemail" value="" placeholder="이메일을 입력해 주세요"></li>
                </ul>    
              </div>
              <div class="memsel4">
                <ul>
...
<script src="${pageContext.request.contextPath}/static/js/joinForm.js?v=<%=System.currentTimeMillis()%>"></script>
</html>