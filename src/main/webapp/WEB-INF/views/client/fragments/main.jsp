            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12 pa20-xs pt0-xs mt30-xs">
                    <span class="img-group">
                        <span>
                            <em class="animated zoomIn"><img src="${pageContext.request.contextPath}/static/img/client/ms01.png" class="img-responsive center-block" alt=""></em>
                        </span>
                    </span>
                </div>
        ...
        <div>
                ...
                <div class="col-sm-6 col-xs-12 life-slider-area">
                    <ul class="life-slider animated fadeInUp">
                       <li>
                            <div>
                                <span>
                                    <img src="${pageContext.request.contextPath}/static/img/client/main_life01.jpg" class="img-responsive center-block" alt="">
                                    <i class="cover"></i>
                                </span>
                                <div class="s-info">
			...
			+ 수도권제2순환고속도로, 인천국제공항고속도로 등 우수한 광역교통망
                        ...
                        <li>
                            <div>
                                <span>
                                    <img src="${pageContext.request.contextPath}/static/img/client/main_life02.jpg" class="img-responsive center-block" alt="">
                                    <i class="cover"></i>
                                </span>
                                <div class="s-info">
			...
			+ 단지 옆 초등학교, 주변에 중·고교 신설 예정, 영어마을도 인접한 명문교육환경
						 ...
						 <li>
                            <div>
                                <span>
                                    <img src="${pageContext.request.contextPath}/static/img/client" class="img-responsive center-block" alt="">
                                    <i class="cover"></i>
                                </span>
                                <div class="s-info">
                                    <em class="num animated fadeInUp">01</em>
